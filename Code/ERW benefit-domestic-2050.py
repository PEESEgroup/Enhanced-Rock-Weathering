...
xh=[]; yh=[] ####### Enthalpy change of reaction 1
f=open('Cropland Area.txt','r') # HSC; kJ/(mol*T) - open the txt file
...
def dland(T):
    return dHcata(T) # This section is real data

xh2=[]; yh2=[] ####### Enthalpy change of reaction 1
f=open('WR.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dWR(T):
    return dHcata2(T) # This section is real data

xh4=[]; yh4=[] ####### Enthalpy change of reaction 1
f=open('Carbon Price Initial.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dCPI(T):
    return dHcata4(T) # This section is real data

xh5=[]; yh5=[] ####### Enthalpy change of reaction 1
f=open('Carbon Price Low.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dCPL(T):
    return dHcata5(T) # This section is real data

xh6=[]; yh6=[] ####### Enthalpy change of reaction 1
f=open('Carbon Price Medium.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dCPM(T):
    return dHcata6(T) # This section is real data

xh7=[]; yh7=[] ####### Enthalpy change of reaction 1
f=open('Carbon Price High.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dCPH(T):
    return dHcata7(T) # This section is real data

xh8=[]; yh8=[] ####### Enthalpy change of reaction 1
f=open('COST.txt','r') # HSC; kJ/(mol*T) - open the txt file
line=f.readline() # Read data from the txt file into a long array
while line:
    arr=line.split()
...
def dCost(T):
    return dHcata8(T) # This section is real data
...
while i<1558: # Adjust the number of regions, i represents the region
    i=i+1
    ...
    while year<26:
        ...
        WR=dWR(i) # WR represents SSA*m*t*WR, already processed
        if WR>1:
            WR=1
        Land=dland(i)
        if year<Deploy_year:
