...
xh = [] 
yh = []  # Prepare for the reading data
...
def dland(T):
    return dHcata(T)  # Perform calculations

xh2 = [] 
yh2 = []  # Prepare for the reading data
...
def dtemperature(T):
    return dHcata2(T)  # Perform calculations

xh1 = [] 
yh1 = []  # Prepare for the reading data
...
def dpH(T):
    return dHcata1(T)  # Perform calculations

xh3 = [] 
yh3 = []  # Prepare for the reading data
...
def dNPP(T):
    return dHcata3(T)  # Perform calculations

xh4 = [] 
yh4 = []  # Prepare for the reading data
...
def dCPI(T):
    return dHcata4(T)  # Perform calculations

xh5 = [] 
yh5 = []  # Prepare for the reading data
...
def dCPL(T):
    return dHcata5(T)  # Perform calculations

xh6 = [] 
yh6 = []  # Prepare for the reading data
...
def dCPM(T):
    return dHcata6(T)  # Perform calculations

xh7 = [] 
yh7 = []  # Prepare for the reading data
...
def dCPH(T):
    return dHcata7(T)  # Perform calculations

xh8 = [] 
yh8 = []  # Prepare for the reading data
...
def dCost(T):
    return dHcata8(T)  # Perform calculations

xh9 = [] 
yh9 = []  # Prepare for the reading data
f = open('US.txt', 'r')  # Open the 'US.txt' file
line = f.readline()  # Read data into an array
while line:
    arr = line.split()
...
def dLCA(T):
    return dHcata9(T)  # Perform calculations

M = 4.0 * 1e3  # Unit: t/km2
x = 20  # um
m = 125  # g mol-1 basalt
t = 3.155 * 1.e7  # s per year, convert time to years
...
while i < 53:  # Adjust the number of regions; i represents the region
    i = i + 1
