...
xh9 = []
yh9 = []  # Prepare for reading data
f = open('ID.txt', 'r')  # Open the file
line = f.readline()  # Read the data into a large array
while line:
    arr = line.split()
...
x = 20  # um
m = 125  # g mol⁻¹ basalt
t = 3.155 * 1.e7  # s a⁻¹, time conversion to years
...
i = 251
while i < 291:  # Adjust the region count, i represents the region
    i = i + 1
    m_rock = []
    m_rock_tot = []
    m_consume_year = []
